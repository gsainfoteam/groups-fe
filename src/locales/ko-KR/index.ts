    ...
    members: {
      ...
      list: {
        ...
        table: {
          ...
          president: "그룹장 임명",
          banishButton: "추방하기",
          appointPresident: "그룹장 임명",
          presidentRequired: "그룹장만 이 작업을 수행할 수 있습니다.",
        },
      },
      banish: {
        banishing: "추방 중...",
      ...
      changePresident: {
        title: "{{name}}님을 그룹장으로 임명하시겠습니까?",
        description: "당신의 권한은 관리자로 변경됩니다.",
        success: "{{name}}님이 그룹장으로 임명되었습니다.",
        error: "그룹장 임명에 실패했습니다. 다시 시도해주세요.",
      },
      role: {
        title: "💡 멤버 역할",
        president: {
